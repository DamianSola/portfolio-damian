...
const StackTech = ( ) => {
    return(
    <div className="w-full md:p-8 p-4 text-center">
        <h1 className="text-2xl">Stack Tech</h1>
        <div className="flex flex-wrap md:justify-around justify-between py-4 text-gray-900">
