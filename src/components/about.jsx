...
const About = () => {
    return(
        <div className=" min-h-dvh p-6 md:px-16 " id="about">
            ...
            <aside className="block py-6 md:p-6 w-full md:text-left text-center">
            <h1 className="text-4xl">Damian Solá</h1>
            <p className="text-xl ">Full Stack Developer</p>
          
            <section className="py-4 items-center md:text-left w-full text-center">
                ...
                <section className="flex justify-center md:justify-left  text-white p-2">
